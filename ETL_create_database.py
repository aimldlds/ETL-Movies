...
def extract_transform_load():
    ...
    file_dir = r'C:\Users\Acer\Downloads\ETL projects Files'
    ...
    # 3. Write a list comprehension to filter out TV shows (and the movies w/o Director and imbd_link).
    ...
    # if s is not a string, return NaN
        ...
        if re.match(r'\$\s*\d+\.?\d*\s*milli?on', s, flags=re.IGNORECASE):
            ...
            s = re.sub('\$|\s|[a-zA-Z]','', s)
            # convert to float and multiply by a million & return
            value = float(s) * 10**6
            return value
        ...
        # if input is of the form $###.# billion
            ...
            s = re.sub('\$|\s|[a-zA-Z]','', s)
            # convert to float and multiply by a billion & return
            value = float(s) * 10**9
            return value
    ...
    # add movies df to SQL:
    db_string = f"postgresql://postgres:{336699}@127.0.0.1:5432/movie_data"
